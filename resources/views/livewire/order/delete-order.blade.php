        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label>
                        <input wire:model.blur="deleteVehicle" name="deleteVehicle" type="radio" value="yes" />
                        Yes
                    </label><br>
                    <label>
                        <input wire:model.blur="deleteVehicle" name="deleteVehicle" type="radio" value="no" />
                        No
                    </label><br>

                    @if($deleteVehicle === 'no')
                        <label for="vehicle_status">Does the Vehicle Status need to change?</label>
                        <select wire:model.live="vehicleStatus" class="form-select" name="vehicle_status" id="vehicle_status">
