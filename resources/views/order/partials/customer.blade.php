<div class="mb-5">
    <button type="button" class="btn btn-primary" wire:click="setNewCustomer(true)">New Customer</button>
    <button type="button" class="btn btn-primary" wire:click="setNewCustomer(false)">Existing Customer</button>
</div>
