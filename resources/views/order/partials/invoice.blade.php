...
<div class="invoice-box">
    ...
    <div class="form-group row">
        <label for="fleet_procure_invoice" class="col-md-2 col-form-label">Fleet Procure Invoice (£)</label>
        <div class="col-md-6">
    ...
    <div class="form-group row">
        <label for="fleet_invoice_number" class="col-md-2 col-form-label">Fleet Procure Invoice Number</label>
        <div class="col-md-6">
    ...
    <div class="row">
        <label class="col-md-2 col-form-label" for="fleet_procure_paid">Fleet Procure Invoice Pay Date</label>
        <div class="col-md-6">
...
<div class="invoice-box">
    ...
    <div class="form-group row">
        <label for="finance_bonus_invoice" class="col-md-2 col-form-label">Finance Company Bonus Invoice (£)</label>
        <div class="col-md-6">
    ...
    <div class="form-group row">
        <label for="finance_company_bonus_invoice_number" class="col-md-2 col-form-label">Finance Company Bonus Invoice Number</label>
        <div class="col-md-6">
    ...
    <div class="form-group row">
        <label class="col-md-2 col-form-label" for="finance_company_bonus_pay_date">Finance Company Bonus Pay Date</label>
        <div class="col-md-6">
...
<div class="invoice-box">
    {{-- Ford Bonus Invoice --}}
    <div class="form-group row">
        <label for="ford_bonus_invoice" class="col-md-2 col-form-label">Ford Bonus Invoice (£)</label>
        <div class="col-md-6">
    ...
    {{-- Ford Bonus pay date --}}
    <div class="form-group row">
        <label class="col-md-2 col-form-label" for="ford_bonus_pay_date">Ford Bonus Pay Date</label>
        <div class="col-md-6">
